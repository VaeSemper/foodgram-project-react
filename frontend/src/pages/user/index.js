  ...
  return <Main>
    <Container className={styles.container}>
      <MetaTags>
        ...
        <meta name="description" content={user ? `Foodgram Assistant - ${user.first_name} ${user.last_name}` : 'Foodgram Assistant - user page'} />
      ...
      >
        {subscribed ? 'Unsubscribe from the author' : 'Subscribes on author'}
      </Button>}
      <CardList>
