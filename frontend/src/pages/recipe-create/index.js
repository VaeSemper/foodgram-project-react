  ...
  return <Main>
    <Container>
      <MetaTags>
        ...
        <meta name="description" content="Foodgram Assistant - creating a recipe" />
        <meta property="og:title" content="Creating a recipe" />
      </MetaTags>
      <Title title='Creating a recipe' />
      <Form
        ...
        <div className={styles.ingredients}>
          ...
          <div className={styles.ingredientsAdded}>
            {recipeIngredients.map(item => {
              ...
              >
                <span className={styles.ingredientsAddedItemTitle}>{item.name}</span> <span className={styles.ingredientsSeparated}>-</span> <span className={styles.ingredientsSeparated}>{item.amount}</span> <span>{item.measurement_unit}</span> <span
